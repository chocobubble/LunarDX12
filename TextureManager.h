...
private:
	...
	Microsoft::WRL::ComPtr<ID3D12Resource> LoadTexture(const LunarConstants::TextureInfo& textureInfo, ID3D12Device* device, ID3D12GraphicsCommandList* commandList, std::string& filename, Microsoft::WRL::ComPtr<ID3D12Resource>& uploadBuffer);
