...
void SceneRenderer::CreateLightVisualizationCubes()
{
    ...
    if (dirLight) 
    {
        ...
        dirTransform.SetLocation(dirLight->Position);
        dirTransform.SetScale({0.3f, 0.3f, 0.3f});
        ...
        for (int i = 1; i <= 3; ++i) 
        {
            ...
            arrowTransform.SetLocation(arrowPos);
            arrowTransform.SetScale({0.1f, 0.1f, 0.1f});
    ...
    if (pointLight) 
    {
        ...
        pointTransform.SetLocation(pointLight->Position);
        pointTransform.SetScale({0.3f, 0.3f, 0.3f});
    ...
    if (spotLight) {
        ...
        spotTransform.SetLocation(spotLight->Position);
        spotTransform.SetScale({0.3f, 0.3f, 0.3f});
        ...
        for (int i = 1; i <= 2; ++i) 
        {
            ...
            spotArrowTransform.SetLocation(spotArrowPos);
            spotArrowTransform.SetScale({0.1f, 0.1f, 0.1f});
